...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .title-row {
            padding: 20px 48px; display: flex; justify-content: space-between; align-items: baseline;
        ...
        .meta-block {
            display: flex; gap: 32px; margin-bottom: 28px; padding-bottom: 16px; border-bottom: 1px solid #cccccc;
        }
        ...
        table.items tbody td {
            padding: 9px 10px; font-size: 13px; color: #333; border-bottom: 1px solid #e5e5e5; vertical-align: top;
        }

        table.items tbody td.num {
            text-align: right; font-variant-numeric: tabular-nums; font-family: 'Courier New', monospace; font-size: 12px;
        }
        ...
        .totals-row:last-child {
            border-bottom: none; border-top: 2px solid #1a1a1a; font-weight: 700; font-size: 14px; background: #f7f7f7;
        }

        .totals-row .t-value { font-family: 'Courier New', monospace; font-size: 12px; }
        .totals-row:last-child .t-value { font-size: 14px; }
...
<body>
    ...
    <div class="title-row">
        <span class="doc-title">Sales Order</span>
        ...
        <div class="parties">
            ...
            <div class="party">
                ...
                <div class="party-detail">
                    <strong>Order Date:</strong> {{ \Carbon\Carbon::parse($document->issue_date)->format('d F Y') }}<br>
                    <strong>Delivery Date:</strong> {{ !empty($document->delivery_date) ? \Carbon\Carbon::parse($document->delivery_date)->format('d F Y') : 'TBD' }}<br>
