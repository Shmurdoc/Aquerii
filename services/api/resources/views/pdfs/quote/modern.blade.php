...
<body>
    ...
    <div class="body">
        ...
        <div class="meta-strip">
            ...
            <div class="meta-cell">
                ...
                <div class="value highlight">{{ \Carbon\Carbon::parse($document->valid_until ?? $document->due_date ?? $document->issue_date)->format('d M Y') }}</div>
            </div>
    ...
    <div class="disclaimer">This is a quotation — not an invoice.</div>
