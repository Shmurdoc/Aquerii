...
<body>
    ...
    <div class="page">
        ...
        <div class="info-grid">
            ...
            <div class="info-block">
                <div class="i-label">{{ $entityType === 'supplier' ? 'Supplier' : 'Customer' }}</div>
            ...
            <div class="info-block">
                ...
                <div class="i-detail">
                    Issued: {{ \Carbon\Carbon::parse($document->issue_date)->format('d M Y') }}<br>
                    Valid Until: {{ \Carbon\Carbon::parse($document->valid_until ?? $document->due_date ?? $document->issue_date)->format('d M Y') }}<br>
