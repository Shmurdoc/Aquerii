...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        table.items tfoot tr { border-top: 1px solid #1a1a1a; }
...
<body>
    ...
    <div class="body">
        ...
        <div class="parties">
            <div class="party">
                <div class="party-label">{{ $entityType === 'supplier' ? 'Supplier' : 'Customer' }}</div>
            ...
            <div class="party">
                <div class="party-label">Quotation Details</div>
                <div class="party-detail">
                    <strong>Issue Date:</strong> {{ \Carbon\Carbon::parse($document->issue_date)->format('d F Y') }}<br>
                    <strong>Valid Until:</strong> <span style="color:#b91c1c;font-weight:700">{{ \Carbon\Carbon::parse($document->valid_until ?? $document->due_date ?? $document->issue_date)->format('d F Y') }}</span><br>
    ...
    <div class="valid-until-line">Valid until {{ \Carbon\Carbon::parse($document->valid_until ?? $document->due_date ?? $document->issue_date)->format('d F Y') }}. This is a quotation — not an invoice.</div>
