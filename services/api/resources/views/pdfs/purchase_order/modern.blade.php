    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .doc-label .doc-number {
            font-size: 13px; color: rgba(255,255,255,0.75); font-weight: 500; margin-top: 2px;
        }
...
<body>
    ...
    <div class="body">
        ...
        <div class="meta-strip">
            ...
            <div class="meta-cell">
                ...
                <div class="value">{{ $document->payment_terms }}</div>
            </div>
            @endif
    ...
    <div class="disclaimer">Please reference PO number on all correspondence and invoices.</div>
