...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .reason-banner .r-label {
            font-size: 10px; font-weight: 600; text-transform: uppercase;
            letter-spacing: 0.8px; color: #991b1b;
        }

        .reason-banner .r-text {
        ...
        table.items tbody td.neg { color: #dc2626; }
        ...
        .disclaimer {
            text-align: center; padding: 24px 40px 12px;
...
<body>
    ...
    <div class="body">
        ...
        <div class="meta-strip">
            ...
            <div class="meta-cell">
                ...
                <div class="value">{{ $document->invoice_number }}</div>
            </div>
            @endif
        ...
        @if(!empty($document->credit_reason))
        <div class="reason-banner">
            <span class="r-label">Reason for Credit</span>
            <span class="r-text">{{ $document->credit_reason }}</span>
        </div>
        @endif
    ...
    <div class="totals-wrapper" style="padding: 0 40px 0;">
        <div class="totals-table">
            ...
            <div class="totals-row total-final">
                <span class="t-label">Credit Total</span>
    ...
    <div class="disclaimer">This document reduces the amount owed.</div>
