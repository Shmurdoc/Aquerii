    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .t-row.final {
            ...
            font-weight: 700; color: #059669; padding-top: 12px; margin-top: 4px;
        }
    ...
    <div class="page">
        ...
        <div class="top-row">
            ...
            <div class="doc-ref">
                ...
                <div><span class="status-badge {{ $statusClass }}">{{ ucfirst($document->status ?? 'cleared') }}</span></div>
            </div>
        </div>
        ...
        <div class="info-grid">
            ...
            <div class="info-block">
                <div class="i-label">Received From</div>
            ...
            <div class="info-block">
                ...
                <div class="i-detail">
                    Date: {{ \Carbon\Carbon::parse($document->payment_date ?? $document->issue_date)->format('d M Y') }}<br>
                    Method: {{ $document->payment_method ?? 'N/A' }}<br>
                    Ref: {{ $document->reference ?? $document->number }}
                </div>
            </div>
        </div>
