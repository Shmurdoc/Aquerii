...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .totals-row:last-child .t-value { font-size: 14px; color: #059669; }
        ...
        .thank-you {
            text-align: center; padding: 16px 48px 0;
            font-size: 13px; color: #059669; font-style: italic;
        }
    </style>
</head>
<body>
    ...
    <div class="title-row">
        <span class="doc-title">Receipt</span>
        ...
        <div class="parties">
            ...
            <div class="party">
                ...
                <div class="party-detail">
                    <strong>Date:</strong> {{ \Carbon\Carbon::parse($document->payment_date ?? $document->issue_date)->format('d F Y') }}<br>
                    <strong>Method:</strong> {{ $document->payment_method ?? 'N/A' }}<br>
                    <strong>Reference:</strong> {{ $document->reference ?? $document->number }}
                </div>
            </div>
        </div>
