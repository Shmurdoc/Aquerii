...
class Workspace extends Model
{
    ...
    protected $fillable = [
        ...
        'icon', 'color',
        'timezone', 'plan', 'plan_status', 'trial_ends_at', 'plan_expires_at',
        'seat_count', 'seat_quota', 'storage_quota_bytes', 'settings',
        'owner_id',
        'stripe_customer_id', 'stripe_subscription_id', 'stripe_subscription_item_id',
        'subscription_id_payfast', 'payfast_subscription_token',
    ];
