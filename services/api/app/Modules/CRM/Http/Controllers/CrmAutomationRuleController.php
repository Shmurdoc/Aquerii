...
class CrmAutomationRuleController extends Controller
{
    ...
    public function store(Request $request, Workspace $workspace): JsonResponse
    {
        $data = $request->validate([
            ...
            'trigger_type'  => 'required|string|in:' . implode(',', \App\Modules\CRM\Services\CrmAutomationService::TRIGGERS),
    ...
    public function update(Request $request, Workspace $workspace, CrmAutomationRule $rule): JsonResponse
    {
        ...
        $data = $request->validate([
            ...
            'description'   => 'nullable|string',
            'trigger_type'  => 'sometimes|string|in:' . implode(',', \App\Modules\CRM\Services\CrmAutomationService::TRIGGERS),
            'trigger_config' => 'nullable|array',
            'conditions'    => 'nullable|array',
