...
use App\Modules\Admin\Filament\Resources\AuditLogResource\Pages\ListAuditLogs;
...
class AuditLogResource extends Resource
{
    ...
    {
        return $table
            ->query(fn () => Model::resolveConnection('pgsql')->table('superadmin.super_admin_audit_log')->orderByDesc('created_at'))
            ->columns([
