...
- Name: app.spec.ts >> Authentication >> redirects unauthenticated user to login
- Location: tests\e2e\app.spec.ts:17:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at https://127.0.0.1/boards
Call log:
  - navigating to "https://127.0.0.1/boards", waiting until "load"
