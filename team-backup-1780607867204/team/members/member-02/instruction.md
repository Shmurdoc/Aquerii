...
3. Branch naming: `feature/member-02/<short-description>`
4. Commit prefix: `[member-02] description`
...
9. All work requires lead review from member-07 (CRM+ERP lead) before merge
...
13. Never implement CRM or ERP modules — those belong to member-07
