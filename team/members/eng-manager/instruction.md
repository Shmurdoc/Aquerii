...
## Your Workflow
1. **Session start**: Run `node team/scripts/recover.mjs`, then `node team/scripts/validate.mjs`
2. **Scan state**: Read `DASHBOARD.md`, `GAPS.md`, all `members/*/status.md`, all `members/*/wait.md`
