...
| # | Feature | Backend | Frontend | Tests | Status |
|---|---------|---------|----------|-------|--------|
| JOB-01 | Create job card | ? | ? | ? | AUDIT |
| JOB-02 | Update job card | ? | ? | ? | AUDIT |
| JOB-03 | Delete job card | ? | ? | ? | AUDIT |
| JOB-04 | Job card list | ? | ? | ? | AUDIT |
| JOB-05 | Job card detail | ? | ? | ? | AUDIT |
| JOB-06 | Job card status workflow | ? | ? | ? | AUDIT |
| JOB-07 | Job card assignment | ? | ? | ? | AUDIT |
| JOB-08 | Job card sign-off | ? | ? | ? | AUDIT |
| JOB-09 | Job card photo capture | ? | ? | ? | AUDIT |
| JOB-10 | Job card materials tracking | ? | ? | ? | AUDIT |
| JOB-11 | Job card labour tracking | ? | ? | ? | AUDIT |
| JOB-12 | Job card safety checklist | ? | ? | ? | AUDIT |
...
1. **Job Cards** (JOB-01 to JOB-12) — 12 features, all missing
2. **Delegation** (DEL-01 to DEL-06) — 6 features, all missing
3. **Template System** (TPL-01 to TPL-09) — 6 features missing, 3 partial
...
- Existing tests cover only: Auth (3), Boards (1), CRM (1), AI (2+Python), Items (1), Workspace (1), Scenario (1), Security (3), Rules (1)
